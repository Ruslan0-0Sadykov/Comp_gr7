...
void processInput(GLFWwindow* window) {
    ...
    // Вращение "локтя" вверх/вниз
    if (glfwGetKey(window, GLFW_KEY_J) == GLFW_PRESS) {
        OX2Angle += deltaTime;
        OX2Angle = glm::clamp(OX2Angle, -glm::radians(90.0f), glm::radians(45.0f));
    }
    if (glfwGetKey(window, GLFW_KEY_K) == GLFW_PRESS) {
        OX2Angle -= deltaTime;
        OX2Angle = glm::clamp(OX2Angle, -glm::radians(90.0f), glm::radians(45.0f));
    }
    OX2Pos = glm::rotate(glm::mat4(1.0f), OX2Angle, glm::vec3(1, 0, 0));

    // Вращение "запястья"
    if (glfwGetKey(window, GLFW_KEY_I) == GLFW_PRESS) {
        OX3Angle += deltaTime;
        OX3Angle = glm::clamp(OX3Angle, -glm::radians(45.0f), glm::radians(90.0f));
    }
    if (glfwGetKey(window, GLFW_KEY_O) == GLFW_PRESS) {
        OX3Angle -= deltaTime;
        OX3Angle = glm::clamp(OX3Angle, -glm::radians(45.0f), glm::radians(90.0f));
    }
    OX3Pos = glm::rotate(glm::mat4(1.0f), OX3Angle, glm::vec3(1, 0, 0));
...
int main() {
    ...
    Model ourModel("Lab_3_VAR_19.obj");
